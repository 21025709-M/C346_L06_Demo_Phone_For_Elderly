package sg.edu.rp.c346.id21025709.demophoneforelderly;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnCallSon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view){
                Intent intentCall = new Intent(Intent.ACTION_DIAL, Uri.parse("tel:" + "+6592240336"));
        ...
        btnCallDaughter.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view){
                Intent intentCall = new Intent(Intent.ACTION_DIAL, Uri.parse("tel:" + "+6589675543"));
                startActivity(intentCall);
            }
        });
    }
